...
import 'package:safe_walker/firebase_options.dart';
...
class CobaBaca extends StatefulWidget {
  const CobaBaca({Key? key}) : super(key: key);

  @override
  _CobaBacaState createState() => _CobaBacaState();
}

class _CobaBacaState extends State<CobaBaca> {
  int _counter = 0;
  ...
  Future<void> _increment() async {
    ...
    await _messagesRef.push().set(<String, String>{_kTestKey: '$_kTestValue $_counter'});
  }
